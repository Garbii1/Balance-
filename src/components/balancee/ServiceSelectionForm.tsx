...
import { carTypes, services } from '@/lib/balancee/data';
import type { CarType, Service } from '@/lib/balancee/types';
...
export function ServiceSelectionForm({ onSubmit }: ServiceSelectionFormProps) {
  const { setCarType, setService, isLoadingStations } = useBalanceeStore();
