...
import type { CarType, Service, Station, TimeSlot, RankedStation } from '@/lib/balancee/types';
import { mockStations, getMockTimeSlots } from '@/lib/balancee/data';
import { rankStations, type RankStationsInput, type RankStationsOutput } from '@/ai/flows/station-ranking';

interface BalanceeState {
...
export const useBalanceeStore = create<BalanceeState>((set, get) => ({
  carType: null,
  service: null,
